...
const InputOTPSlot = React.forwardRef(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex size-11 sm:size-12 items-center justify-center rounded-md border border-input bg-background text-base sm:text-lg font-semibold shadow-xs transition-all",
